...
class FileNames
{
  ...
  public:
    ...
    static PCWSTR ParameterizeName(PWCHAR pwzDst, PCWSTR pwzPath);
    static PCWSTR ParameterizeName(PWCHAR pwzDst, FileInfo *pInfo);
...
PCWSTR FileNames::ParameterizeName(PWCHAR pwzDst, FileInfo *pInfo)
{
    return ParameterizeName(pwzDst, pInfo->m_pwzPath);
}

PCWSTR FileNames::ParameterizeName(PWCHAR pwzDst, PCWSTR pwzPath)
{
...
BOOL TblogOpen()
{
    ...
    swprintf_s(wzPipe, ARRAYSIZE(wzPipe), L"%ls.%d", TBLOG_PIPE_NAMEW, s_nTraceProcessId);
#else
    swprintf(wzPipe, L"%ls.%d", TBLOG_PIPE_NAMEW, s_nTraceProcessId);
#endif
                                ...
                                LPPROCESS_INFORMATION lpProcessInformation)
{
    ...
    __try {
        ...
        if (rv) {
            ...
            Print("<t:Executable>%ls</t:Executable>\n", FileNames::ParameterizeName(wzPath, pInfo));
